  ...
  async function persistTrackingSnapshot({
    ...
    await pool.query(
      ...
      do update set
        ...
        actual_departure = coalesce(excluded.actual_departure, public.user_flights.actual_departure),
        actual_arrival = coalesce(excluded.actual_arrival, public.user_flights.actual_arrival),
        departure_terminal = coalesce(excluded.departure_terminal, public.user_flights.departure_terminal),
        departure_gate = coalesce(excluded.departure_gate, public.user_flights.departure_gate),
        arrival_terminal = coalesce(excluded.arrival_terminal, public.user_flights.arrival_terminal),
        arrival_gate = coalesce(excluded.arrival_gate, public.user_flights.arrival_gate),
        baggage_claim = coalesce(excluded.baggage_claim, public.user_flights.baggage_claim),
      ...
      [
        userId,
        flightId,
        normalized.flightInstanceId || null,
        userFlightLifecycle,
        displayCode,
        normalized.airlineCode || null,
